...
class TestStrategy(bt.Strategy):
    ...
    def next(self):
        ...
        if self.live_data:
            #cash, value = self.broker.get_wallet_balance('KRW')
...
apikey = 'zYs6rpkUjDzvNE0ihQsytMEoZxCrigPn00MqLDTf'
secret = '036FT7x09wOsslHbDq1L6Mb5xwToAo5nkLaDP2py'
...
store = CCXTStore(exchange='upbit', currency='KRW', config=config, retries=5, debug=False)
...
data = store.getdata(dataname='KRW-BTC', name="KRW-BTC",
...
store.get_balance()
print("Total value:", broker.getvalue())
